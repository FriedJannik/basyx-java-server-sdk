...
dependencies {
    ...
    testImplementation(project( path =":basyx.submodelregistry-service-inmemory-storage", configuration = "testArtifacts"))
}

description = "basyx.submodelregistry-feature-authorization"
